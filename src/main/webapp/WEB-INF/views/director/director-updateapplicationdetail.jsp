					...
					<table>
						<tr>
							...
							<td><form:input readonly="true" type="text" path="id"
									value="${applicationdetail.id }" /></td>
						</tr>
						<tr>
							<td><form:label path="name">Название детали</form:label></td>
							<td>${applicationdetail.name}</td>
						</tr>
						<tr>
						...
						<tr>
							<td><form:label path="dateOrder">Дата заявки:</form:label></td>
							<td><fmt:formatDate value="${applicationdetail.dateOrder }"
						...
						<tr>
							...
							<td><form:select path="status">
									<form:option value="status"
										label="${applicationdetails.status.status }" />
									<c:forEach items="${statuss}" var="statuss">
										<c:if
											test="${applicationdetails.status.status ne statuss.status}">
